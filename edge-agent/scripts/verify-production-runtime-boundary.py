...
def main() -> None:
    ...
    retired_storage_methods = {
        ...
        "create_family",
        "is_family_member",
        "_device_binding_code_to_dict",
        "_expire_device_binding_codes",
        "list_family_device_bindings",
        "get_device_binding",
        "create_device_binding",
        "create_device_binding_code",
        "list_device_binding_codes",
        "consume_device_binding_code",
        "issue_device_token",
        "get_active_device_token_by_device",
        "get_family",
        "list_user_families",
