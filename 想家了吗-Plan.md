...
12. [ ] 执行双摄有人、遮挡、快速移动、离开、宠物和电视内容实测，目标活跃人物 Pose 每路约 `10-15 Hz`；记录 Hailo 队列、合并/替换、阶段 P50/P95、CPU、温度、Tracker 锚点 Hz 和真实成品 FPS。空场实测已定位单帧原始 Pose 反复延长 active 的根因；本地已拆分“候选正式验证”和“Tracker 快速重锚”，初始空帧、单帧候选、等待去重和正式拒绝专项通过，待完整回归与 Pi 二次反证。
