...
11. [ ] 生产机已安装官方 MediaMTX `v1.19.3` 和 Coturn `4.6.1`；三组独立生产密钥、Coturn 受保护配置、目录访问边界和 `3478/tcp` 监听已完成。继续完成 MediaMTX/TLS、云安全组、nginx、匿名/跨路径拒绝、真实盒子发布、直连 ICE 和强制 TURN；完成前整批迁移不得部署。
