...
阶段 23 当前状态：P0/P1/P2 已完成并部署真实树莓派。P1 关闭算法页时双摄 idle 实测约 0.99-1.15 FPS/路，双路视频约 7.97-7.98 FPS。P2 在同一历史真人帧上的姿态阶段中位数由约 0.461 秒降至 0.068 秒，减少 85.3%；包含外层 YOLO 的完整模型链由约 0.711 秒降至 0.318 秒，减少 55.3%。生产代码完整复验为 `external_person_boxes / pose ready`，高置信真人帧保留 1 人和 1 组坐姿骨架；部署后 120 秒双摄观察无新增姿态错误，live relay 持续无错误，温度约 60.6-62.8 摄氏度。下一步进入 P3 OC-SORT/KLT 连续跟踪；当前尚无真实 `tracked` 关键点传播，真实人物 active 2 FPS、risk 3-5 FPS、300ms 风险触发和 1.5-3 秒候选延迟仍需后续验收。
