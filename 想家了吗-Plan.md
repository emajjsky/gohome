...
11. [ ] 生产机已安装并稳定运行官方 MediaMTX `v1.19.3` 和 Coturn `4.6.1`；三组独立生产密钥、分离配置边界、TLS、nginx、匿名拒绝、证书部署钩子和 Certbot dry-run 已完成。腾讯云安全组仍阻断 `8322/8189/3478`，继续完成端口开放、跨路径拒绝、真实盒子发布、直连 ICE 和强制 TURN；完成前整批迁移不得部署。
